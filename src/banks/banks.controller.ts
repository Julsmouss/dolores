...
export class BanksController {
    ...
    create(@Body() createBankDto : CreateBankDto, @Res() response){
        this.banksService.createBank(createBankDto).then( bank => {
    ...
    @Get()
    getAll(@Res() response){
        this.banksService.getAll().then( banksList => {
    ...
    getById(@Res() response,@Param('id') idBank){
        this.banksService.getById(idBank).then( bank => {
    ...
    update(@Body() updateBankDto: CreateBankDto, @Res() response, @Param('id') idBank : number){
        this.banksService.updateBank(idBank, updateBankDto).then(bankUpdated => {
    ...
    delete(@Res() response, @Param('id') idBank : number){
        this.banksService.deleteBank(idBank).then(res => {
